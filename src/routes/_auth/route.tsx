				...
				>
					...
					>
						...
						>
							...
							>
								...
								>
									...
									{isLoginRoute ? (
										<p className="auth-brand-copy-subtle max-w-[22rem] text-sm leading-7">
											Sign in to return to your saved
											sources, summaries, and ongoing
											research flow.
										</p>
									) : null}
								</div>
								...
								{isSignupRoute ? (
									<p className="auth-brand-note max-w-[22rem] pt-1 text-sm leading-7">
										Built for focused collection, clean
										summaries, and steady research habits
										over time.
									</p>
								) : null}
							</div>
							...
							<div
								className={`auth-brand-copy hidden max-w-[30rem] text-sm leading-7 lg:block ${isCompactAuthRoute ? 'hidden' : ''}`}
							>
								Secure access to your saved sources, summaries,
